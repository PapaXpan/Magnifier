...
#magnifier {
  ...
  overflow: hidden;
  box-shadow: 0 0 20px rgba(255, 87, 51, 0.5); /* Add glow effect */
  pointer-events: none;
  z-index: 1000;
...
function xpanMagnify(image_, zoomLevel = 4, magnifierSize = 250, borderRadius = 0, backgroundColor = 'transparent') {
  ...
  function startMagnifier(element) {
    ...
    if (image) {
      ...
      magnifier.style.backgroundColor = backgroundColor; // Set background color dynamically
